...
# Replace common "Not Available" representations with NaN
...
# Drop any rows that still have NaN after conversion (in case of non-numeric values)
data = data.dropna()
...
# Since H_COMP_5_STAR_RATING is categorical (1 to 5), convert to one-hot encoding
...
model.save('staff_new.keras')

# Save the model in pickle format
with open('staff_new.pkl', 'wb') as f:
    pickle.dump(model, f)
