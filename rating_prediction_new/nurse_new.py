...
# Since H_COMP_1_STAR_RATING is categorical (1 to 5), convert to one-hot encoding
...
with open('nurse_scaler.pkl', 'wb') as f:
...
model.save('nurse_new.keras')

# Save the model in pickle format
with open('nurse_new.pkl', 'wb') as f:
    pickle.dump(model, f)
